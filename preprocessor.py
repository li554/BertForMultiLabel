...
class EnglishPreProcessor(object):
    ...
    def remove_website(self, sentence):
        ...
        :return:
        """
        sentence_repl = re.sub(r"http[://a-z0-9.]+", "url",sentence)
        sentence_repl = re.sub(r"https[://a-z0-9.]+", "url",sentence_repl)
        return sentence_repl

    def remove_name_tag(self, sentence):
        # Remove name tag
        sentence_repl = re.sub(r"@[a-z0-9.]+", "",sentence)
        return sentence_repl
    ...
    def adjust_common(self, sentence):
        ...
        sentence_repl = re.sub(r"fucksex", "fuck sex", sentence_repl)
        sentence_repl = re.sub(r"f u c k", "fuck", sentence_repl)
        return sentence_repl

    def remove_chinese(self, sentence):
        # Chinese bad word
        sentence_repl = re.sub(r"幹", "fuck", sentence)
...
if __name__ == '__main__':
    sentence = "that sounds fucking gooood,& which is a nice idea"
